				...
				<section className="my-tab">My Tab</section>
					<ul className="menu-nav">
						<li className="dashboard-menu-item">
							<a href="#my-space"><i className="fa fa-home"></i>&nbsp;&nbsp;My Space</a>
						</li>
						<li className="dashboard-menu-item">
							<a href="#groups"><i className="fa fa-group"></i>&nbsp;&nbsp;My Groups</a>
						</li>
						<li className="dashboard-menu-item">
							<a href="#search"><i className="fa fa-search"></i>&nbsp;&nbsp;Search PostIt</a>
						</li>
						<li className="dashboard-menu-item">
							<a href="#search-wiki"><i className="fa fa-wikipedia-w"></i>&nbsp;&nbsp;Search Wikipedia</a>
						</li>
						<li className="dashboard-menu-item">
